...
class WorldMap:
    ...
    # ASCII world map using simple characters for reliable rendering
    MAP = (
        ...
        "    |                                                                             |\n"
        "    +-----------------------------------------------------------------------------+\n"
        "    |  * = Major Target    [US] vs [USSR]    DEFCON: Monitoring Global Situation  |\n"
        "    +-----------------------------------------------------------------------------+"
    )

    # Simple labeled map for clarity
    MAP_COMPACT = (
        "                              GLOBAL THERMONUCLEAR WAR\n"
        "    +-----------------------------------------------------------------------------+\n"
        "    |                                                                             |\n"
        "    |       .---.                                     .----------.                |\n"
        "    |      / USA \\          ATLANTIC               ,'   EUROPE   `.    ASIA      |\n"
        "    |     |   *   |           OCEAN               |    *          |-----.        |\n"
        "    |      \\     /                                 \\   Moscow    ,'      \\       |\n"
        "    |       `---'                                   `-----------'    *    |      |\n"
        "    |         |                                                    Beijing|      |\n"
